...
This tutorial teaches you some of the basic concept in [Vaadin Framework](https://vaadin.com).It is meant to be
a fast read for learning how to get started  not an example on how application hould be
designed. Please nte this example uses and requires Java 8 to work.

![Addressbook Screenshot](addressbook_screenshot.png "Addressbook Screenshot")


Running the example from the command lin
------------------
```
$ mvn jetty:run
```
...
--------------------
These instructions were tested on Intelli IDEA 14 CE. You can get it from https://www.jetbrains.com/idea/

To get the project up and running in IDEA, do:
- File -> New -> Project from Version Control -> Git
- The URL to use is https://github.com/vadin/addressbook.git
...
- Select GlassFish Server 4.1 -> Remember in Current IDE Session -> O
